<div class="container2">
    ...
    <fieldset>
        <legend><?= __('Añadir evaluaciones a materia') ?></legend>
        <div class="form-group">
            <?= $this->Form->input('categoria_id',['label'=>'','options'=>$cate]); ?>
         </div>
         <div class="form-group">
